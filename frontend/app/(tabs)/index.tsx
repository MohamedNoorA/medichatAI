...
export default function Index() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.1.6:5000/api/chat', {
        method: 'POST',
        headers: {
      ...
      const newAiMessage: Message = {
        ...
        text: data.reply, // Use the response from the backend
        isUser: false,
        timestamp: new Date(),
      };
      ...
      // Fallback: Add a default error message if the API call fails
